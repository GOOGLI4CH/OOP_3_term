...
namespace lab07
{
    public class CustomList<T> : List<T>, IGeneric<T> where T : Inventory.Inventory
    {
        ...
        public void WriteCollectionInFile(string path)
        {
        ...
        public static void ReadCollectionFromFile(string path)
        {
            if (File.Exists(path))
            {
